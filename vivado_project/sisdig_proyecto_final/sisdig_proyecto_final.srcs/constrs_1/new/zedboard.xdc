...
set_property PACKAGE_PIN AB20 [get_ports {VGA_B2}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {VGA_B3}];  # "VGA-B4"
...
set_property PACKAGE_PIN AA21 [get_ports {VGA_G3}];  # "VGA-G4"
...
set_property PACKAGE_PIN V18  [get_ports {VGA_R3}];  # "VGA-R4"
set_property PACKAGE_PIN Y19  [get_ports {VGA_VS}];  # "VGA-VS"

# ----------------------------------------------------------------------------
# User Push Buttons - Bank 34
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {btn_x1}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {btn_x2}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {btn_y1}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {btn_y2}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {btn_z1}];  # "BTNU"
#set_property PACKAGE_PIN T18 [get_ports {btn_z2}];  # "BTNU"
